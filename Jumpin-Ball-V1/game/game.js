...
Clarity.prototype.keydown = function (e) {
    ...
    switch (e.keyCode) {
        ...
        case 83:
            ...
            break;
        case 32:
            if (_this.pauseFlag) { Loop(); _this.pauseFlag = false;}
            else { cancelAnimationFrame(anim); _this.pauseFlag = true;}
            break;
        case 74://j
...
Clarity.prototype.move_player = function () {
    ...
    if (this.dash_switch > 0) { this.player.vel.x = this.key.left ? -10 : 10; this.dash_switch--; }
    ...
    if (this.player.loc.y > this.current_map.height_p + 100) { localStorage.setItem("deathCount_drop", ++game.player.deaths.drop); game.load_map(map[0]); }
...
/* camera开始移动的距离差 */
game.camera.movement_limit = { x: 8, y: 8 };
